...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($ID_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err)) {
        ...
        $sql = "INSERT INTO students (student_id, email, password) VALUES (?, ?, ?)";
...
<body>
    <form method="post" id="signupForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <div class="form-group <?php echo (!empty($email_err)) ? 'has-error' : ''; ?>">
            ...
            <input type="email" class="form-control" name="email" id="email" aria-describedby="email" placeholder="Enter ID" value="<?php echo $email; ?>">
        ...
        <div class="form-group <?php echo (!empty($group_err)) ? 'has-error' : ''; ?>">
            ...
            <span class="help-block"><?php echo $group_err; ?></span>
        </div>
